                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`flex-1 sm:flex-initial px-3 sm:px-3.5 py-1.5 sm:py-2 text-xs font-serif-title font-bold transition-all border flex items-center justify-center gap-1.5 whitespace-nowrap ${
                                    isActive
